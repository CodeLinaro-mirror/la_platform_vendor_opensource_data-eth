...
#define EASYMESH_QUEUE_RX_TX_BE	IPA_MUL_QUEUE_BE3

#define EASYMESH_CHANNEL_RX_TX_BE_TAGGED	IPA_MUL_CHANNEL_BE0
#define EASYMESH_CHANNEL_RX_TX_BE	IPA_MUL_CHANNEL_BE3
