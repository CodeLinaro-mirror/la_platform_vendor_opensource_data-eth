...
#define MIN_DMA_RIWT		0x40
/* Tx coalesce parameters */
#define STMMAC_COAL_TX_TIMER	1000
#define STMMAC_MAX_COAL_TX_TICK	100000
#define STMMAC_TX_MAX_FRAMES	256
#define STMMAC_TX_FRAMES	1
#define STMMAC_RX_FRAMES	16
/* Opportunistic TX cleanup budgets used in stmmac_napi_poll_rx().
 * HEAD: pre-RX pass, frees ring space for ACKs queued before the DL batch.
 * TAIL: post-RX pass, frees ring space for ACKs generated by received segments.
 */
#define STMMAC_TX_TRYLOCK_BUDGET_HEAD	16
#define STMMAC_TX_TRYLOCK_BUDGET_TAIL	24
